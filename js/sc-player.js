...
/*           updates.position.innerHTML = timecode(position); */
  ...
  $.scPlayer = function(options, node) {
    var opts = $.extend({}, $.scPlayer.defaults, options),
        ...
        $player
          .find('.sc-controls')
            .append('<a href="#previous" class="sc-previous disabled">Previous</a> <a href="#play" class="sc-play">Play</a> <a href="#pause" class="sc-pause">Pause</a> <a href="#next" class="sc-next">Next</a>')
          .end()
  ...
  // MAYBE ABLE TO DO NEXT AND PREVIOUS WITH THIS
  // toggling play/pause
